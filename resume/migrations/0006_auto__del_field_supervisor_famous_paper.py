...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Supervisor.famous_paper'
        db.delete_column(u'resume_supervisor', 'famous_paper')


    def backwards(self, orm):
        # Adding field 'Supervisor.famous_paper'
        db.add_column(u'resume_supervisor', 'famous_paper',
